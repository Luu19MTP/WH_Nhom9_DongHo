...
public class EmailUtils {
    ...
    private static final String SENDER_ADDRESS = "";    // mail bên gửi
    private static final String SENDER_PASSWORD = "";   // mật khẩu (ứng dụng) mail bên gửi
    private static final String RECEIVER_ADDRESS = "";  // mail bên nhận (admin)
